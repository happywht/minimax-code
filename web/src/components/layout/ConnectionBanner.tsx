...
export function ConnectionBanner({
  ...
  return (
    <div
      ...
      className="pointer-events-auto fixed inset-x-3 top-3 z-40 mx-auto max-w-2xl animate-rise-in rounded-lg border border-line bg-surface-1/95 px-3 py-2 text-xs shadow-pop backdrop-blur"
      role="status"
      aria-live="polite"
    >
