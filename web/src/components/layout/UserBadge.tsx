    ...
    <div ref={triggerRef} className="relative" data-testid="user-badge">
      {editing ? (
        <div className="flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-left">
          ...
          <span className="min-w-0 flex-1">
            <span className="block truncate text-xs font-medium text-ink-0">
              {name}
            </span>
            <Input
              fieldSize="sm"
        ...
        <button
          ...
          onClick={() => setOpen((v) => !v)}
          className="flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-left text-sm transition-colors duration-150 hover:bg-surface-3"
        >
          <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-accent-subtle text-[11px] font-semibold text-accent">
            {initials || "U"}
          </span>
          <span className="min-w-0 flex-1">
            ...
            <span
              ...
              className="mt-0.5 flex items-center gap-1 truncate text-[11px] text-ink-1"
            >
      ...
      {open &&
        ...
        (() => {
          ...
          return createPortal(
            <div
              className="fixed z-50 w-56 overflow-hidden rounded-lg border border-line bg-surface-1 p-1 shadow-pop"
              style={{
                left: rect?.left ?? 0,
            ...
            >
              <div className="px-2 py-1.5">
                <div className="truncate text-xs text-ink-0">{name}</div>
                <div className="truncate text-[11px] text-ink-1">
                  {email}
                </div>
              </div>
