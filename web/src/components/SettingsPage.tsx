...
import type { AuditEntry, OrchestrationMode, PermissionRule, ProviderInfo, ProviderModel, ScheduledJob, WebhookConfig, WorkflowEntry } from "../types/ipc";
...
function TeamsTab(): JSX.Element {
  ...
  const _update = useTeamStore((s) => s.update); // TODO: inline edit in v0.8.1
