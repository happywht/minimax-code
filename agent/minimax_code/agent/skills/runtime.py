...
def _build_agent_core(
    *,
    ...
    config = AgentConfig(
        ...
        # v1.1.1 → v1.6.1: sub-agent budget aligned with the other
        # sub-agent defaults (orchestrator / DAO / team runtime, all 100).
        max_iterations=int(max_iterations) if max_iterations else 100,
