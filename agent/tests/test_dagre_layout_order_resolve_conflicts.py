...
def test_order_subpackage_barrel_reexports_all_four() -> None:
    ...
    Synchronised at R261: the barrel now also re-exports
    ``resolve_conflicts`` (the fourth ``order`` leaf, the Forster
    conflict resolver), so ``__all__`` grew from ``["barycenter",
    "cross_count", "init_order"]`` to the ASCII-sorted ``["barycenter",
    "cross_count", "init_order", "resolve_conflicts"]``. Mirrors the
    R255 -> R254 / R257 -> R254 / R259 -> R258 / R260 -> R258+R259
    barrel-sync pattern.
    """
